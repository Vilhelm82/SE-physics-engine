...
1. **Dark-space orientation gates:** strongest immediate native construction. Equation (5) is proved for the full declared fibre; (6) gives a measurable ideal gate. Next deliver finite-duration and perturbation bounds, then compare hardware-constrained paths. The occupation-dependent spectrum (7) is the first many-body extension test.
