...
The native inputs are [BR-3/4/7](2026-09-05-response-on-branched-resolved-state-spaces.md), [predictive-state closure](2026-09-05-cella-predictive-state.md), and Cella's normalized-incidence and special-fibre constructions. Retain the slow states before taking the limit that removes their relaxation rates.
...
1. **Dark-space orientation gates:** strongest immediate native construction. Equation (5) is proved for the full declared fibre; (6) gives a measurable ideal gate. The linked control extensions now supply certified logical and full quadratic detuning cancellation, an arbitrary-order native response calculation, and explicit temporal/resource costs. The immediate control target is full second-order leakage cancellation at the shorter duration, with gain sensitivity and return index chosen together. The occupation-dependent spectrum (7) is the first many-body extension test.
