...
Written 2026-09-03.  `suites/thm_j_dyn.py` **7/7**, `run_thm_j_dyn.log`.  Read after `docs/results/2026-09-03/2026-09-03-thm-target-I.md`.
...
3. **The model's own candidate (D-3).**  The only frozen, choice-free geometry the model owns is the state-space metric of
   `docs/archive/GRAM_SUBMERSION_CURVATURE` (round metric on (S²)³, mechanical connection, horizontal lift, quotient metric on
