...
Claire, 2026-09-05 evening.  Runner `experiments/2026-09-05/claire_v0_thirteen.py` (30 seeded starts, ~6 min), receipt `docs/receipts/claire-v0-thirteen-checks.json`.
...
See `docs/receipts/claire-v0-thirteen-checks.json`, key `centre`.  Three admissible solutions were found in 30 starts (W = 17.954,
