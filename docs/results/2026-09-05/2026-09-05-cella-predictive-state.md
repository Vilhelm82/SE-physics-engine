...
The [runner](../../../cella_predictive_state.py) implements the terminating polynomial pair-ideal construction and checks its invariance certificate. It also verifies the native reconstructions, the zero-coupling case, the horizon experiment, unknown-material counts, power and branch transport, delayed distinguishability, a nontrivial removable state, and finite material-memory reductions. The [receipt](../../../../receipts/cella-predictive-state-checks.json) records its exact checks; it supplements the proofs above.
...
- Existing PINCH-1/2/3, [constitutive divisors](../../../../results/2026-09-05/2026-09-05-cella-constitutive-divisors.md) and [dependency reconciliation](../../../../results/2026-09-05/2026-09-05-cella-dependency-reconciliation.md): the resolved chart, the response family and power-preserving projection. Their existing proofs are retained.
