...
**Resolved constitutive continuation.** [The Cella weighted-response extension](/home/williaml/seated-root/docs/results/2026-09-05/2026-09-05-cella-constitutive-divisors.md), Theorem 3, now generates this same path from the constant resolved matrix \(\widehat M=\left(\begin{smallmatrix}1+k^2&k\\k&1\end{smallmatrix}\right)\) on \((\xi,d)\). Its pushforward differs from (12) for other efforts and stays smooth as a full response on the resolved state. [The implicit-cut calculation](/home/williaml/seated-root/docs/results/2026-09-05/2026-09-05-cella-normal-geometry.md) then computes both expansions and the full Ricci tensor below directly from the selected metric and cut jets.
