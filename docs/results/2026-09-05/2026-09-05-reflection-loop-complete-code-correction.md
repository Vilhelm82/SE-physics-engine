...
At $\nu/a^2=10$, [the control records](../../../../receipts/reflection-loop-short-controls.json) specify the following exact nearby roots:
...
![Resources, gain order, finite-error loss choices and the remaining reference-drift response](../../../../figures/reflection-loop-short-tradeoffs.png)
...
[Response runner](../../../reflection_loop_short_correction.py) · [interval certificate](../../../reflection_loop_detuning_certificate.py) · [124-check receipt and full matrices](../../../../receipts/reflection-loop-short-checks.json) · [controls](../../../../receipts/reflection-loop-short-controls.json).
