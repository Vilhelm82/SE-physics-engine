...
Replay: `OPENBLAS_NUM_THREADS=1 python3 rlq/rh2_precision.py --json docs/receipts/rh2_precision-checks.json | tee docs/receipts/rh2_precision.log`

**Closed form found 2026-09-06 (RH-2A, `docs/results/2026-09-06/2026-09-06-RH-2A-a0-closed-form.md`):** a0 = 3375 sqrt(5) pi^3/32768 exactly;
