...
print("  through the normal = e_2(sym grad v) = 0 and curl curl v = 0.  These are the COMPLETE normal projections (G_nn, G_ni) of the")
print("  presentation.  The tangential components G_ij are computable from (h, v) in the stationary case (O-6d does it) but no model")
print("  law owns their value -- that is the debt this suite measures at O(eps^2) (O-6).")
print()
...
print("  READING: Gauss and Codazzi are the complete NORMAL projections of the presentation, and they are satisfied.  The six")
print("  tangential components are determined by (h, v) here but owned by no model law -- and at O(eps^2) they")
